...
/**
 * Created by Julieti on 11/05/2017.
 */

public class PermitirLocalizacaoActivity {

    public static void requestPermission(MapaActivity activity, int requestId,
                                         String permission, boolean finishActivity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            PermitirLocalizacaoActivity.RationaleDialog.newInstance(requestId, finishActivity)
